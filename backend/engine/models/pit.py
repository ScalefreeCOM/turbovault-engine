...
class PIT(models.Model):
    ...
    pit_physical_name = models.CharField(
        max_length=255,
        help_text="Physical name of the PIT structure"
    )
    ...
    def tracked_entity(self):
        ...
        return self.tracked_hub if self.tracked_entity_type == self.TrackedEntityType.HUB else self.tracked_link
    ...
    def __str__(self) -> str:
        entity_name = self.tracked_entity.hub_physical_name if self.tracked_hub else \
                      self.tracked_entity.link_physical_name if self.tracked_link else "Unknown"
