...
class GenerationReport:
    ...
    effectivity_satellites_generated: int = 0
    ...
    def total_entities(self) -> int:
        ...
        return (
            ...
            + self.effectivity_satellites_generated
            + self.pits_generated
    ...
    def add_error(
        self, entity_type: str, entity_name: str, message: str, code: str = ""
    ) -> None:
    ...
    def add_skipped(self, entity_type: str, entity_name: str, reason: str) -> None:
        """Add a skipped entity to the report."""
        self.skipped.append(
            SkippedEntity(
                entity_type=entity_type, entity_name=entity_name, reason=reason
            )
        )
    ...
    def summary(self) -> str:
        ...
        lines = [
            ...
            f"  - Effectivity satellites: {self.effectivity_satellites_generated}",
