...
|                | `column_type`                 | `'payload'` if column `Target_Primary_Key_Physical_Name` in `non_historized_link` is empty, if it is populated, ``dependant_child_key``                                                             |
...
|                | `column_type`                 | `dependant_child_key`  if column `Target_Primary_Key_Physical_Name `in `standard_link` is not empty.                                                                                                |
